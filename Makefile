#############################################################################
# Makefile for building: knifemoney-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed Aug 26 01:01:12 2015
# Project:  knifemoney-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile knifemoney-qt.pro
#############################################################################
...
Makefile: knifemoney-qt.pro  ../../QT/4.8.6/mkspecs/default/qmake.conf ../../QT/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile knifemoney-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/working/knife/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/working/knife/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/working/knife/src/leveldb/libleveldb.a: FORCE
	cd C:/working/knife/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -fno-keep-inline-dllexport -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a && ranlib C:/working/knife/src/leveldb/libleveldb.a && ranlib C:/working/knife/src/leveldb/libmemenv.a
